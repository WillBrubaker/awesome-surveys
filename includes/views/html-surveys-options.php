...
<div id="general-surveys-options">
	<fieldset>
		...
		<div class="control-group"><label class="control-label" for="captcha_site_key"><?php _e( 'Your re-captcha Site Key', 'awesome-surveys' ) ?></label><div class="controls"><input type="text" name="options[general_options][captcha_site_key]" id="captcha_site_key" value="<?php echo $options['general_options']['captcha_site_key']; ?>"></div>
	</div>

		<div class="control-group"><label class="control-label" for="captcha_secret_key"><?php _e( 'Your re-captcha Secret', 'awesome-surveys' ) ?></label><div class="controls"><input type="password" name="options[general_options][captcha_secret_key]" id="captcha_secret_key" value="<?php echo $options['general_options']['captcha_secret_key']; ?>"></div>
	</div>
